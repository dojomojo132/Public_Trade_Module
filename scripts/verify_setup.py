...
required_files = {
    ...
    ".github/VAULT_STRUCTURE.md": "Карта Obsidian vault",
    ".github/agents/planner.agent.md": "Планировщик",
    ".github/agents/1c-coder.agent.md": "BSL-разработчик",
    ".github/agents/closer.agent.md": "Закрытие задачи",
    ".github/agents/1c-xml-editor.agent.md": "XML-редактор",
    ".github/skills/1c-xml-editor/SKILL.md": "Скилл XML-редактора",
