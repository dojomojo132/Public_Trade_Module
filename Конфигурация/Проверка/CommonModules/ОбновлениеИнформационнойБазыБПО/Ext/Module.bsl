...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("1446dd8a-bb1b-439b-9291-002f73c18b97");
	...
	Обработчик.Версия = "3.2.5.3";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("60b72a08-318f-47e6-bbc4-0decdf3b683a");
	Обработчик.Комментарий = НСтр("ru = 'Отключение регламентного задания отправки электронных сообщений в разделенном режиме.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыБПО.УстановитьСрокХраненияОперацийСОборудованием";
	Обработчик.Версия = "3.2.5.4";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("cbe6ac05-81f4-4adc-a076-7c7004763a0d");
	Обработчик.Комментарий = НСтр("ru = 'Установка срока хранений операций с оборудованием.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыБПО.УстановитьСрокХраненияОперацийСОборудованием";
	Обработчик.Версия = "3.2.6.21";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("1b6d29fd-f61b-4b55-9540-227fe1dea0d3");
	Обработчик.Комментарий = НСтр("ru = 'Установка срока хранений операций с оборудованием.'");
	...
	Обработчик.Версия = "3.2.7.6";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("ce880442-c73f-4961-b6a2-4817ede7948e");
	Обработчик.Комментарий = НСтр("ru = 'Установка срока хранений операций с оборудованием.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = "Справочники.ОфлайнОборудование.УстановитьВерсиюФорматаОбменаККМED";
	Обработчик.Версия = "3.2.7.38";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("295e22e4-9d3f-4915-b592-46a33dfc4f22");
	Обработчик.Комментарий = НСтр("ru = 'Установка версии формата обмена в экземпляре Офлайн-оборудования.'");
...
Процедура УстановитьСрокХраненияОпераций(Параметры = Неопределено) Экспорт 
	...
	УстановитьСрокХраненияОперацийСОборудованием(Параметры);
...
Процедура УстановитьСрокХраненияОперацийСОборудованием(Параметры = Неопределено) Экспорт
	...
	Если ОбщегоНазначенияБПО.ИспользуетсяПодсистемаЛогирования() Тогда
		...
		МодульЛогированиеОперацийБПО.УстановитьСрокХраненияОперацийСОборудованием();
	КонецЕсли;
...
Процедура ОтключитьИспользованиеРегламентногоЗадания(Параметры = Неопределено) Экспорт
	...
	Если ОбщегоНазначенияБПО.ИспользуетсяРассылкаЭлектронныхЧеков() Тогда
		...
		МодульРассылкаЭлектронныхЧеков.ОтключитьИспользованиеРегламентногоЗадания();
	КонецЕсли;
