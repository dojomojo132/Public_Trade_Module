...
Процедура ОтраслевойРеквизитЗаполняетсяДляТиповТоваров(ТипыТоваров) Экспорт
	...
	_ДемоПодключаемоеОборудованиеВызовСервера.ОтраслевойРеквизитЗаполняетсяДляТиповТоваров(ТипыТоваров);
...
Процедура ВедетсяОбъемноСортовойУчет(ОбъемноСортовойУчет, СтандартнаяОбработка) Экспорт
	...
	_ДемоПодключаемоеОборудованиеВызовСервера.ВедетсяОбъемноСортовойУчет(ОбъемноСортовойУчет, СтандартнаяОбработка);    
...
Процедура ОказываютсяУслугиОбщественноеПитания(ОбщественноеПитание, СтандартнаяОбработка) Экспорт
	...
	_ДемоПодключаемоеОборудованиеВызовСервера.ОказываютсяУслугиОбщественноеПитания(ОбщественноеПитание, СтандартнаяОбработка);    
