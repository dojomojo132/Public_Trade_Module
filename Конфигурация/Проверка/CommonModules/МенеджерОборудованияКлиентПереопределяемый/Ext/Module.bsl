...
// Дополнительные переопределяемые действия с управляемой формой в Экземпляре оборудования
// подключаемой процедуры "Подключаемый_ПриИзмененииЭлементаФормы"
//
// Параметры:
//  Объект - СправочникОбъект.ПодключаемоеОборудование - объект подключаемого оборудования.
//  ЭтотОбъект - СправочникОбъект.ПодключаемоеОборудование - текущий объект подключаемого оборудования..
...
// Обработать событие подключаемого оборудования.
// 
// Параметры:
//  Событие - Имя внешнего события 
//  Данные - Данные внешнего события
//  СтандартнаяОбработка - Булево - если Ложь, дальнейшая обработка не требуется 
//
Процедура ОбработатьСобытиеПодключаемогоОборудования(Событие, Данные, СтандартнаяОбработка) Экспорт    
