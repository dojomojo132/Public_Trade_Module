...
Процедура Сформировать(Команда)
	...
	Сообщение.Текст = "[1] Кнопка нажата, вызываю сервер...";
	Сообщение.Сообщить();
	...
	Исключение
		...
		СообщениеОшибки.Текст = "[ОШИБКА] " + ОписаниеОшибки();
		СообщениеОшибки.Сообщить();
	КонецПопытки;
	
	Сообщение = Новый СообщениеПользователю;
	Сообщение.Текст = "[3] Сервер вернул управление";
	Сообщение.Сообщить();
...
Процедура СформироватьОтчет()
	...
	Сообщение = Новый СообщениеПользователю;
	Сообщение.Текст = "[2] Сервер: начинаю формирование...";
	Сообщение.Сообщить();
	...
	Сообщение = Новый СообщениеПользователю;
	Сообщение.Текст = "[2] Сервер: записано в Результат, ВысотаТаблицы=" + Строка(Результат.ВысотаТаблицы);
	Сообщение.Сообщить();
