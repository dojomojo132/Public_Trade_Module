...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "СканерШтрихкод" Тогда
		// Аппаратный сканер (COM/NativeAPI) прислал штрихкод
		ОбработкаШтрихкода(Параметр);
		
	ИначеЕсли ИмяСобытия = "ИзмененыНастройкиПоУмолчанию" Тогда
		// Полное обновление панели: размеры кнопок + количество в ряду + количество рядов
