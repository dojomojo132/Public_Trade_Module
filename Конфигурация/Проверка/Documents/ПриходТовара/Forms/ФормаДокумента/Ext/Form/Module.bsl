...
Асинх Процедура ТоварыШтрихкодПриИзменении(Элемент)
	...
	Если НайденнаяНоменклатура = Неопределено Тогда
		...
		Если Результат = КодВозвратаДиалога.Да Тогда
			...
			Ждать ОткрытьФормуАсинх("Справочник.Номенклатура.ФормаЭлемента", ПараметрыФормы);
			
			// После закрытия формы — ищем созданный товар
			НайденнаяНоменклатура = НайтиНоменклатуруПоШтрихкоду(ЗапомненныйШтрихкод);
			Если НайденнаяНоменклатура <> Неопределено Тогда
