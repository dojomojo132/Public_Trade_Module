...
Процедура ПриОткрытии(Отказ)
	...
	// Фокус на поле сканирования для приёма данных от USB-сканера
	АктивироватьСканирование();
...
// Обработка поля сканирования ШК (USB HID-сканер в режиме эмуляции клавиатуры).
// Сканер набирает штрихкод + Enter в это поле.
//
&НаКлиенте
Процедура ПолеВводаШтрихкодаПриИзменении(Элемент)
	
	Если Не ПустаяСтрока(ПолеВводаШтрихкода) Тогда
		ОбработатьШтрихкодСканера(ПолеВводаШтрихкода);
	КонецЕсли;
...
// Устанавливает фокус на поле сканирования для приёма следующего штрихкода.
//
&НаКлиенте
Процедура АктивироватьСканирование()
	Если Элементы.Найти("ПолеВводаШтрихкода") <> Неопределено Тогда
		ТекущийЭлемент = Элементы.ПолеВводаШтрихкода;
	КонецЕсли;
КонецПроцедуры
