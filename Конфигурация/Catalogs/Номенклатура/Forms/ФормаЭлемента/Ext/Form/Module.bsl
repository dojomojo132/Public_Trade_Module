...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Предзаполнение штрихкода при создании из ПриходТовара
	Если Не ЗначениеЗаполнено(Объект.Ссылка)
		И Параметры.Свойство("ИсходныйШтрихкод")
		И Не ПустаяСтрока(Параметры.ИсходныйШтрихкод) Тогда
		НоваяСтрока = Объект.Штрихкоды.Добавить();
		НоваяСтрока.Штрихкод = Параметры.ИсходныйШтрихкод;
	КонецЕсли;
