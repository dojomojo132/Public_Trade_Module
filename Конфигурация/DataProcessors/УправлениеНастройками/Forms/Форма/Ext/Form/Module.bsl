...
Процедура ЗагрузитьНастройки()
	...
	НазваниеОсновнойБД = НастройкиПоУмолчанию.ПолучитьНазваниеОсновнойБД();
	НазваниеКассовойБД = НастройкиПоУмолчанию.ПолучитьНазваниеКассовойБД();
	...
	ЕстьПустыеНастройки = ЕстьПустыеНастройки ИЛИ (НазваниеОсновнойБД = Неопределено);
	ЕстьПустыеНастройки = ЕстьПустыеНастройки ИЛИ (НазваниеКассовойБД = Неопределено);
...
Процедура СохранитьНастройкиНаСервере()
	...
	НастройкиПоУмолчанию.УстановитьЗначениеНастройки(Справочники.НастройкиПоУмолчанию.НазваниеОсновнойБД, НазваниеОсновнойБД);
	НастройкиПоУмолчанию.УстановитьЗначениеНастройки(Справочники.НастройкиПоУмолчанию.НазваниеКассовойБД, НазваниеКассовойБД);
...
Процедура ИнициализироватьЗначенияПоУмолчанию()
	...
	// Название основной БД - по умолчанию пустая строка
	Если НазваниеОсновнойБД = Неопределено Тогда
		НазваниеОсновнойБД = "";
	КонецЕсли;
	
	// Название кассовой БД - по умолчанию пустая строка
	Если НазваниеКассовойБД = Неопределено Тогда
		НазваниеКассовойБД = "";
	КонецЕсли;
