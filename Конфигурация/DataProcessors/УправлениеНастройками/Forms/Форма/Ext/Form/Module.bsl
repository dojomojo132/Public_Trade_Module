...
Процедура ЗагрузитьНастройки()
	...
	КонтролироватьФискальныеОстатки = НастройкиПоУмолчанию.ПолучитьКонтрольФискальныхОстатков();
	...
	ЕстьПустыеНастройки = ЕстьПустыеНастройки ИЛИ (КонтролироватьФискальныеОстатки = Неопределено);
...
Процедура СохранитьНастройкиНаСервере()
	...
	НастройкиПоУмолчанию.УстановитьЗначениеНастройки(Справочники.НастройкиПоУмолчанию.КонтролироватьФискальныеОстатки, КонтролироватьФискальныеОстатки);
...
Процедура ИнициализироватьЗначенияПоУмолчанию()
	...
	Если КонтролироватьФискальныеОстатки = Неопределено Тогда
		КонтролироватьФискальныеОстатки = Истина;
	КонецЕсли;
