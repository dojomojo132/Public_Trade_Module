...
Процедура ВыборВидаОплатыЗавершение(ВыбранныйЭлемент, НастройкиРазделения) Экспорт
	...
	Если ВидОплаты = "Карта" Тогда
		...
		ПараметрыОповещения = Новый Структура("ВидОплаты, КассаНаличных", ВидОплаты, НастройкиРазделения.КассаНаличных);
		Оповещение = Новый ОписаниеОповещения("ПодтверждениеОплатыСРазделениемЗавершение", ЭтотОбъект, ПараметрыОповещения);
...
&НаКлиенте
Процедура ПодтверждениеОплатыСРазделениемЗавершение(Результат, ДополнительныеПараметры) Экспорт
	
	Если Результат = КодВозвратаДиалога.Да Тогда
		ВыполнитьОформлениеСРазделением(ДополнительныеПараметры.ВидОплаты, ДополнительныеПараметры.КассаНаличных);
	Иначе
...
Процедура ВыборВидаВозвратаПоОплатеЗавершение(ВыбранныйЭлемент, НастройкиРазделения) Экспорт
	...
	Если ВидОплаты = "Карта" Тогда
		...
		ПараметрыОповещения = Новый Структура("ВидОплаты, КассаНаличных", ВидОплаты, НастройкиРазделения.КассаНаличных);
		Оповещение = Новый ОписаниеОповещения("ПодтверждениеВозвратаСРазделениемЗавершение", ЭтотОбъект, ПараметрыОповещения);
...
&НаКлиенте
Процедура ПодтверждениеВозвратаСРазделениемЗавершение(Результат, ДополнительныеПараметры) Экспорт
	
	Если Результат = КодВозвратаДиалога.Да Тогда
		ВыполнитьОформлениеВозврата(ДополнительныеПараметры.КассаНаличных);
	Иначе
		Сообщение = Новый СообщениеПользователю;
