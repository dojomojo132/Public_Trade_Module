...
// Розничная (основная) цена номенклатуры на дату.
// Источник: РС.ЦеныНоменклатуры (измерения Номенклатура + ТипЦен, периодичность Секунда).
// Тип цен: настройка ОсновнойТипЦен, иначе предопределённый «Розничная».
//
// Параметры:
//  АктуальнаяДата - Дата - граница среза последних
//  Номенклатура - СправочникСсылка.Номенклатура
//
// Возвращаемое значение:
//  Число - цена; 0 если тип цен не задан или записи нет
//
