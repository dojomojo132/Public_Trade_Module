...
// Возвращает значение настройки "Контролировать фискальные остатки"
//
// Возвращаемое значение:
//   Булево - Истина если контроль фискальных остатков включен
//
Функция ПолучитьКонтрольФискальныхОстатков() Экспорт
	
	ИмяНастройки = Справочники.НастройкиПоУмолчанию.КонтролироватьФискальныеОстатки;
...
Функция ПолучитьВсеНастройки() Экспорт
	...
	Настройки.Вставить("КонтролироватьФискальныеОстатки", ПолучитьКонтрольФискальныхОстатков());
...
Функция ПолучитьДефолтныеЗначения()
	...
	Элемент = Новый Структура("Ключ, Значение", 
		Справочники.НастройкиПоУмолчанию.КонтролироватьФискальныеОстатки, 
		Истина);
	Дефолты.Добавить(Элемент);
