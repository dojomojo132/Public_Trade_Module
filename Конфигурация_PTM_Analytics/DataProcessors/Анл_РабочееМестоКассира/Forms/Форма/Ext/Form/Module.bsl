...
// Цена для РМК: розничный/основной тип цен (явно), через универсальную ПолучитьЦену.
//
&НаСервере
Функция ПолучитьЦенуНоменклатуры(Номенклатура)
	...
	Возврат ОбщегоНазначения.ПолучитьЦену(ТекущаяДатаСеанса(), Номенклатура, ТипЦен);
