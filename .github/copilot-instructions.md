...
|---|----------|------------|------|
| 1 | **Техническая спецификация** | Единственный источник истины | `Документация/Спецификации/ТЕХНИЧЕСКАЯ СПЕЦИФИКАЦИЯ КОНФИГУРАЦИИ PTM.xml` |
| 2 | **Алгоритм разработки** | Процесс работы | `Документация/Спецификации/Алгоритм разработки.xml` |
| 3 | **Стандарт описания объектов** | Шаблон документирования | `Документация/Спецификации/Стандарт_описания_объектов.xml` |
| 4 | **Стандарты 1С** | Синтаксис, именование, правила | `Документация/Технические_стандарты/1c-standards-8.3.27.md` |
| 5 | **XML-структура** | Формат файлов конфигурации | `Документация/Технические_стандарты/xml-structure-8.3.27.md` |
| 6 | **Элементы форм** | UI-компоненты | `Документация/Технические_стандарты/form-elements.md` |
...
├─────────────────────────────────────────────────────────────────┤
│ 1. Использовать Документация/Технические_стандарты/1c-standards-8.3.27.md для проверки │
│ 2. ТОЛЬКО асинхронные методы (Асинх/Ждать)                      │
│ 3. Именование: русский CamelCase                                │
│ 4. Для форм: Документация/Технические_стандарты/form-elements.md │
│ 5. Для XML: Документация/Технические_стандарты/xml-structure-8.3.27.md │
└─────────────────────────────────────────────────────────────────┘
                              ↓
┌─────────────────────────────────────────────────────────────────┐
│ ЭТАП 4: ВАЛИДАЦИЯ                                               │
...
| Проверка имени формы | `file_search` | — | Искать в Конфигурация/ |
| Исправление | `get_metadata_structure` | — | Проверить имена полей |
| Форма | `get_metadata_structure` | Документация/Технические_стандарты/form-elements.md | Использовать шаблон |
| XML-редактирование | — | Документация/Технические_стандарты/xml-structure-8.3.27.md | Проверить структуру |
