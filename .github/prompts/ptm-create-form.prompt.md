---
description: "Создание формы для объекта метаданных 1С:Предприятие PTM: дескриптор, Form.xml, Module.bsl с правильными ID, BOM, CRLF."
agent: "1c-form-builder"
tools: [read, search, edit, execute]
argument-hint: "Тип объекта (Document/Catalog/DataProcessor), имя объекта, имя формы"
---

Создай форму для объекта метаданных PTM.
