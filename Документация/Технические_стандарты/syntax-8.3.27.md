# Синтаксис 1C:Enterprise 8.3.27

## КРИТИЧНО: Асинхронность (Обязательно!)

### Вариант 1 — Асинх/Ждать (рекомендуется с 8.3.24+)
```bsl
// Клиентский код — асинхронный с Асинх/Ждать
&НаКлиенте
...
### Вариант 2 — ОписаниеОповещения (совместимость)
```bsl
&НаКлиенте
