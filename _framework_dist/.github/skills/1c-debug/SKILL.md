...
| `workspace.configRoot` | Путь к выгруженной конфигурации | `{config.paths.config_root}` |
...
- Путь к BSL-файлу в `debug_set_breakpoints` — абсолютный путь к Module.bsl в `{config.paths.config_root}/`
